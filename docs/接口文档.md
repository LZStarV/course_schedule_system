...
```json
{
  ...
  "params": { "keyword": "算法", "credit": 3, "avoidConflict": true, "page": 1, "page_size": 20 }
}
```
...
```json
{
  ...
  "data": {
    ...
    "pagination": { "page": 1, "page_size": 20, "total": 200, "total_pages": 10 }
  }
}
```
...
```json
{
  ...
  "params": { "keyword": "admin", "role": "ADMIN", "status": "ACTIVE", "page": 1, "page_size": 10 }
}
```
...
```json
{
  ...
  "params": { "id": "uuid", "email": "a@b.com", "role": "ADMIN", "status": "INACTIVE" }
}
```
...
```json
{ "id": "...", "method": "Admin.DeleteUser", "params": { "id": "uuid" } }
```
