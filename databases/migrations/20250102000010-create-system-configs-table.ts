...
export default {
  up: async (queryInterface: QueryInterface) => {
    await queryInterface.createTable('system_configs', {
      ...
      config_value: { type: DataTypes.JSONB, allowNull: false, defaultValue: {} },
      value_type: { type: DataTypes.STRING(20), allowNull: false },
      description: { type: DataTypes.TEXT, allowNull: true },
      version: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 1 },
      scope: { type: DataTypes.STRING(50), allowNull: false },
      is_encrypted: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
