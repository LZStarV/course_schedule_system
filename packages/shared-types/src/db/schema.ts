...
export type DepartmentStatus = z.infer<
...
export type CourseStatus = z.infer<
  typeof CourseStatusSchema
>;
...
export type LocationType = z.infer<
  typeof LocationTypeSchema
>;
...
export type EnrollmentStatus = z.infer<
  typeof EnrollmentStatusSchema
>;
...
export type SelectionMethod = z.infer<
  typeof SelectionMethodSchema
>;
...
export type EnrollmentTimetableItem = z.infer<
  typeof EnrollmentTimetableItemSchema
>;
...
export const RpcResponseSchema = <T extends z.ZodTypeAny>(
  item: T
) => RpcResponseBaseSchema.extend({ data: item });
export type RpcResponse<T> = z.infer<
  typeof RpcResponseBaseSchema
> & { data: T };
...
export type PaginatedRequest = z.infer<
  typeof PaginatedRequestSchema
>;
...
export type GradeEntryItem = z.infer<
  typeof GradeEntryItemSchema
>;
...
export type GradeEntryRequest = z.infer<
  typeof GradeEntryRequestSchema
>;
...
export type ModulePermission = z.infer<
...
export type PermissionData = z.infer<
  typeof PermissionDataSchema
>;
